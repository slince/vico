...
export const KnowledgeSearchToolRenderer: ToolCallMessagePartComponent<KnowledgeSearchArgs, KnowledgeSearchResult> = ({ status, args, result, isError, approval, interrupt, resume, addResult, respondToApproval }) => {
